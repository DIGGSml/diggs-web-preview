...
// all the rows and columns for the different items. We literally
...
function generateMenuContent(idXMLData)
{
	...
	// each one of them
	var aMenuSections = oXMLDoc.getElementsByTagName('Borehole'); // This extracts each "Borehole" and makes a new row in the table
	for (i=0; i < aMenuSections.length; i++)
	{
		...
		var sName = aMenuSections.item(i).getAttribute('gml:id');
